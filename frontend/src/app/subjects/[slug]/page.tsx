...
import { SubjectQuickNavigation } from "@/components/subject-quick-navigation";
import { SubjectScrollReset } from "@/components/subject-scroll-reset";
      ...
      <main className="min-h-[calc(100vh-180px)] bg-[var(--sanabil-cream)]">
        ...
        <section className="px-5 py-10 sm:px-8 sm:py-14">
          <div className="mx-auto max-w-5xl space-y-5">
            ...
            <SubjectQuickNavigation subjects={subjects} currentSlug={subject.slug} />
